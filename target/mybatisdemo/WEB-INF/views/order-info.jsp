...
<div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
         <span class="r">共有数据：<strong>${requestScope.orderNum}</strong> 条</span> </div>
        <span class="r"></span>
        <div class="mt-20">
            <table class="table table-border table-bordered table-hover table-bg table-sort">
                ...
                <c:forEach items="${requestScope.orderInfo}" var="order">
                    <tr class="text-c">
                        ...
                        <td>${order["depTime"]}</td>
                        <td>${order["arrTime"]}</td>
                        <td>${order["psg_type"]}</td>
                        <td>${order["carrierName"]}</td>
                        <td class="td-manage">
                                <%--/*<a title="编辑" href="javascript:;" onclick="picture_edit('修改用户信息','client-modify-user.html',${client.id},'${client.uname}',${client.phone},${client.idNumber},${client.assets} )" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>--%>
                            <a title="删除" href="Order/${order["orderID"]}/delete" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
