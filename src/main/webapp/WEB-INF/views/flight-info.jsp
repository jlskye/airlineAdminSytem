...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 航班信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">

    <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l"> <a href="Flight/add" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加航班</a></span> <span class="r">共有数据：<strong>${requestScope.flightNum}</strong> 条</span> </div>
        <span class="r"></span>
    <div class="mt-20">
        <table class="table table-border table-bordered table-hover table-bg table-sort">
            ...
            <tr class="text-c">
                ...
                <th width="40">启程机场</th>
                <th width="40">抵达机场</th>
                <th width="100">启程时间</th>
                <th width="100">抵达时间</th>
                <th width="50">启程城市</th>
                <th width="50">抵达城市</th>
                <th width="70">归属航空公司</th>
                <th width="100">操作</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${requestScope.flightInfo}" var="flight">
                <tr class="text-c">
                    <td><input type="checkbox" value="${flight["flightID"]}" name="flightID"></td>
                    ...
                    <td class="td-manage">
                        <a title="编辑" href="Flight/${flight["flightID"]}/update" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
